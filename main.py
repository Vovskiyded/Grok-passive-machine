...
PRODUCTS = {
    "1": {"ua": "Автоматизація бізнесу (20 кодів)", "en": "Business Automation (20 codes)",
          ...
          "teaser_ua": "20 готових кодів, які повністю автоматизують продажі, збір лідів, постинг, парсинг цін конкурентів і генерацію звітів. Кожен код йде з детальною інструкцією. Повна версія — після оплати."},
