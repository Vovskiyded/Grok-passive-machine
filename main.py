...
PRODUCTS = {
    ...
    "4": {"ru": "Grok TikTok Rocket", "en": "Grok TikTok Rocket", "price": 59, "file": "tiktok_bot.py",
    ...
    "7": {"ru": "Grok Lead Hunter", "en": "Grok Lead Hunter", "price": 35, "file": "lead_bot.py",
    ...
    "8": {"ru": "Grok Passive System", "en": "Grok Passive System", "price": 27, "file": "blueprint.txt",
    ...
    "9": {"ru": "Grok Newbie Launchpad", "en": "Grok Newbie Launchpad", "price": 19.99, "file": "beginner_guide.txt",
...
print("🚀 Бот с тизерами 30% запущен")
